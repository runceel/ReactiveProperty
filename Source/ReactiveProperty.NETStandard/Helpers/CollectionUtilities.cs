...
public static class CollectionUtilities
{
    ...
    /// <returns></returns>
    private static IObservable<TResult> ObserveElementCore<TElement, TResult>(IEnumerable<TElement> source, Func<TElement, IObserver<TResult>, IDisposable> subscribeAction)
        where TElement : class
    {
