    ...
    public class ValidationViewModel
    {
        ...
        public ValidationViewModel()
        {
            ...
            ValidationData = new ReactiveProperty<string>()
                .SetValidateNotifyError(s => !string.IsNullOrEmpty(s) && s.All(Char.IsUpper) ? null : "not all uppercase");
            ...
            ValidationBoth = new ReactiveProperty<string>()
                .SetValidateNotifyError(s => !string.IsNullOrEmpty(s) && s.All(Char.IsLower) ? null : "not all lowercase")
                .SetValidateNotifyError(self => self
