...
namespace StoreApp.Views
{
    ...
    /// </summary>
    public sealed partial class Asynchronous : Page
    {

        private NavigationHelper navigationHelper;
        private AsynchronousViewModel defaultViewModel = new AsynchronousViewModel();

        /// <summary>
        /// これは厳密に型指定されたビュー モデルに変更できます。
        /// </summary>
        public AsynchronousViewModel DefaultViewModel
        {
