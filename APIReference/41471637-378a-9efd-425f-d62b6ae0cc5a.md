...
<a href="http://msdn2.microsoft.com/en-us/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;Reactive.Bindings.Notifiers.BusyNotifier<br />
...
**C#**<br />
``` C#
public class BusyNotifier : INotifyPropertyChanged, 
	IObservable<bool>
```

The BusyNotifier type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="4a60f0bd-60a0-dca4-3581-81911f93d735">BusyNotifier</a></td><td>
Initializes a new instance of the BusyNotifier class</td></tr></table>&nbsp;
<a href="#busynotifier-class">Back to Top</a>
