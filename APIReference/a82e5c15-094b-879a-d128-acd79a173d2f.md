# IReactiveProperty(*T*) Interface
 

\[Missing <summary> documentation for "T:Reactive.Bindings.IReactiveProperty`1"\]
...
public interface IReactiveProperty<T> : IReactiveProperty, 
	IHasErrors, IObservable<T>, IDisposable, INotifyPropertyChanged, INotifyDataErrorInfo

```


#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>\[Missing <typeparam name="T"/> documentation for "T:Reactive.Bindings.IReactiveProperty`1"\]</dd></dl>&nbsp;
The IReactiveProperty(T) type exposes the following members.
