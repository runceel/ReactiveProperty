# ReadOnlyReactiveCollection.ToReadOnlyReactiveCollection(*T*) Method (ReadOnlyObservableCollection(*T*), IScheduler)
...
#### Type Parameters
&nbsp;<dl><dt>T</dt><dd>\[Missing <typeparam name="T"/> documentation for "M:Reactive.Bindings.ReadOnlyReactiveCollection.ToReadOnlyReactiveCollection``1(System.Collections.ObjectModel.ReadOnlyObservableCollection{``0},System.Reactive.Concurrency.IScheduler)"\]</dd></dl>

#### Return Value
Type: <a href="b12e7e8c-f79a-9768-f64e-f5fe747e1d4a">ReadOnlyReactiveCollection</a>(*T*)<br />\[Missing <returns> documentation for "M:Reactive.Bindings.ReadOnlyReactiveCollection.ToReadOnlyReactiveCollection``1(System.Collections.ObjectModel.ReadOnlyObservableCollection{``0},System.Reactive.Concurrency.IScheduler)"\]
