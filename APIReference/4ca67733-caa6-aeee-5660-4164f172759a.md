# ObservableCollectionExtensions.ObserveElementObservableProperty(*TElement*, *TProperty*) Method (ReadOnlyObservableCollection(*TElement*), Expression(Func(*TElement*, IObservable(*TProperty*))))
