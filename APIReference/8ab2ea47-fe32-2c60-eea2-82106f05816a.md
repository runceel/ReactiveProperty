# INotifyPropertyChangedExtensions.ToReactivePropertyAsSynchronized(*TSubject*, *TProperty*) Method (*TSubject*, Expression(Func(*TSubject*, *TProperty*)), IScheduler, ReactivePropertyMode, Boolean)
